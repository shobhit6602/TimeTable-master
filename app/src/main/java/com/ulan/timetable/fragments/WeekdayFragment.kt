...
class WeekdayFragment : Fragment {
    ...
    private fun setupAdapter(view: View) {
        ...
        val weeks = db!!.getWeek(key)
        adapter = WeekAdapter(db!!, requireActivity() as AppCompatActivity, listView, 0, weeks)
    ...
    private fun setupListViewMultiSelect() {
        ...
        listView!!.setMultiChoiceModeListener(
            FragmentHelper.setupListViewMultiSelect(
    ...
    companion object {
        const val KEY_MONDAY_FRAGMENT = "Monday"
        const val KEY_TUESDAY_FRAGMENT = "Tuesday"
        const val KEY_WEDNESDAY_FRAGMENT = "Wednesday"
        const val KEY_THURSDAY_FRAGMENT = "Thursday"
        const val KEY_FRIDAY_FRAGMENT = "Friday"
        const val KEY_SATURDAY_FRAGMENT = "Saturday"
        const val KEY_SUNDAY_FRAGMENT = "Sunday"
    }
}