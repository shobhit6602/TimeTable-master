...
class NoteInfoActivity : AppCompatActivity() {
    ...
    private fun setupIntent() {
        ...
        note = intent.getSerializableExtra(NotesActivity.Companion.KEY_NOTE) as Note
    ...
    override fun onBackPressed() {
        Objects.requireNonNull(note).setText(text!!.text.toString())
        db!!.updateNote(note!!)
        Toast.makeText(this@NoteInfoActivity, resources.getString(string.saved), Toast.LENGTH_SHORT)
            .show()
        super.onBackPressed()
    }
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                ...
                Toast.makeText(
                    ...
                    resources.getString(string.saved),
                    Toast.LENGTH_SHORT
                ).show()
                super.onBackPressed()
                true
