    ...
    fun setupListViewMultiSelect(
        ...
        return object : MultiChoiceModeListener {
            override fun onItemCheckedStateChanged(
                ...
                mode.title =
                    checkedCount.toString() + " " + activity.resources.getString(string.selected)
                    ...
                    R.id.action_delete -> {
                        ...
                        while (i < checkedItems.size()) {
                            ...
                            if (checkedItems[key]) {
                                ...
                                removelist.add(adapter.weekList[key])
                            }
                            i++
                        }
                        adapter.weekList.removeAll(removelist)
                        db.updateWeek(adapter.week)
