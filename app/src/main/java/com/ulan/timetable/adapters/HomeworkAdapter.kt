...
class HomeworkAdapter(
    ...
    listView: ListView?,
    resource: Int,
    objects: ArrayList<Homework?>
) : ArrayAdapter<Homework?>(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val description = Objects.requireNonNull(getItem(position)).getDescription()
        val date = Objects.requireNonNull(getItem(position)).getDate()
        val color = Objects.requireNonNull(getItem(position)).getColor()
        homework = Homework(subject, description, date, color)
        ...
        holder.date.setText(WeekUtils.localizeDate(context, homework.getDate()))
            ...
            popup.setOnMenuItemClickListener(object : PopupMenu.OnMenuItemClickListener {
                override fun onMenuItemClick(item: MenuItem): Boolean {
                    ...
                    if (itemId == R.id.delete_popup) {
                        ...
                        val alertLayout =
                            mActivity.layoutInflater.inflate(R.layout.dialog_add_homework, null)
                        AlertDialogsHelper.getEditHomeworkDialog(
                            dbHelper!!,
                            mActivity,
                            alertLayout,
                            homeworkList,
